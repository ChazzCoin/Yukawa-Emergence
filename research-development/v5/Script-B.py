...
To test the internal consistency of the construction, we performed a Monte Carlo study in which random proto-Yukawa and proto-Majorana matrices were generated and subjected to the full alignment, reduction, seesaw, and renormalization-group pipeline described above. No parameter fitting or optimization was performed. We find that the resulting low-energy flavor observables are generically of the correct order of magnitude, with hierarchical quark masses, suppressed CKM mixing, large lepton mixing, and neutrino mass splittings consistent with a seesaw scale Λ ≃ 10¹⁴ GeV.
