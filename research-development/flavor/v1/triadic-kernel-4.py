...
if __name__ == "__main__":
    ...
    # For example, automatically scan beta on the best triad and best gcd seeds:
    # scan_beta_for_seed(best_triad["seed"])
    # scan_beta_for_seed(best_gcd["seed"])
    # β-scans: reuse the same routine for any seed you care about
