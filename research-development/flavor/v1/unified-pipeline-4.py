...
if __name__ == "__main__":
    ...
    phase_e_base = (0, 10)
    phase_nu_base = (0, 25)
    for N_eff in [360, 180, 120, 90, 72, 60]:
        print(f"\n=== N_eff = {N_eff} ===")
        for seed in range(5):
            res = run_pipeline_for_seed(
                seed,
                phase_u=phase_u_base,
                phase_d=phase_d_base,
                phase_e=phase_e_base,
                phase_nu=phase_nu_base,
                noise_level=0.05,
                N_eff=N_eff,
            )
            print(f"  seed {seed:2d}: chi2 = {res['chi2']:.3g}")
...
#
# if __name__ == "__main__":
#     # Example: use the aligned phase set we found reasonable
#     phase_u = (0, 2)
#     phase_d = (0, 3)
#     phase_e = (0, 10)
#     phase_nu = (0, 25)
...
#
#     print("\n=== Masses at EW scale (GeV) ===")
#     print("up:  ", np.sort(mu_vals))
#     print("down:", np.sort(md_vals))
#     print("lep: ", np.sort(me_vals))
#     print("nu (GeV):", np.sort(mnu_vals))
#
#     print("\n=== Mass ratios (normalized to heaviest) ===")
#     print("up   :", np.sort(mu_vals)/np.max(mu_vals))
#     print("down :", np.sort(md_vals)/np.max(md_vals))
#     print("lep  :", np.sort(me_vals)/np.max(me_vals))
#     print("nu   :", np.sort(mnu_vals)/np.max(mnu_vals))
#
#     print("\n=== Quark mixing angles (deg) ===")
#     print("theta12 =", math.degrees(th12_q))
#     print("theta23 =", math.degrees(th23_q))
#     print("theta13 =", math.degrees(th13_q))
#     print("delta_CP (q) =", math.degrees(delta_q))
#
#     print("\n=== Lepton mixing angles (deg) ===")
#     print("theta12 =", math.degrees(th12_l))
#     print("theta23 =", math.degrees(th23_l))
#     print("theta13 =", math.degrees(th13_l))
#     print("delta_CP (ℓ) =", math.degrees(delta_l))
#
#     print("\nGlobal chi2 =", res["chi2"])
