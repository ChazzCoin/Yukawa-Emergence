...
class Config:
    ...
    seed = 12345              # will be overwritten per run
...
def schur_9_to_3(Y9):
    ...
    if cond(D) > 1e12:
        # You can choose to resample if desired
        pass
...
# experimental targets (rough, illustrative)
x_exp = np.array([
    # mass ratios
    0.007,    # m_c/m_t
    1e-5,     # m_u/m_t
...
def make_observables(res):
    ...
    # mass ratios
    obs.append(mu[1] / mu[2])   # m_c/m_t
    obs.append(mu[0] / mu[2])   # m_u/m_t
    obs.append(md[1] / md[2])   # m_s/m_b
    obs.append(md[0] / md[2])   # m_d/m_b
    obs.append(me[1] / me[2])   # m_mu/m_tau
    obs.append(me[0] / me[2])   # m_e/m_tau
    ...
    # neutrino splittings (already in eV²)
    obs.append(dm2_21)
    obs.append(dm2_31)
...
if __name__ == "__main__":
    ...
    # Example: inspect first run’s masses/angles
    r0 = all_results[0]
    print("Up masses (GeV):   ", r0["mu"])
    print("Down masses (GeV): ", r0["md"])
    print("Lepton masses (GeV):", r0["me"])
    print("Neutrino masses (GeV):", r0["mnu"])
    print("Δm² (eV²):", r0["dm2_eV2"])
    print("CKM angles (rad):", r0["th_q"], "δq:", r0["delta_q"])
    print("PMNS angles (rad):", r0["th_l"], "δℓ:", r0["delta_l"])

"""
seed 0: chi2 = 3.15e+11
seed 1: chi2 = 6.28e+11
seed 2: chi2 = 3.34e+11
seed 3: chi2 = 1.99e+12
seed 4: chi2 = 5.61e+11
seed 5: chi2 = 1.21e+11
seed 6: chi2 = 3.48e+11
seed 7: chi2 = 1.98e+12
seed 8: chi2 = 1e+11
seed 9: chi2 = 1.15e+12
Up masses (GeV):    [173.          98.03343071  61.81870875]
Down masses (GeV):  [4.18       2.10441329 1.17978011]
Lepton masses (GeV): [1.777      0.95946632 0.27931202]
Neutrino masses (GeV): [1.79496240e-11 2.29162352e-12 5.27999032e-13]
Δm² (eV²): (np.float64(4.972755376990609e-06), np.float64(0.0003219102171818199))
CKM angles (rad): (np.float64(0.13957632864255404), np.float64(0.8267278387010908), np.float64(0.3097024509826795)) δq: 0.5401866894369959
PMNS angles (rad): (np.float64(0.48379036959704874), np.float64(0.7169030584071493), np.float64(0.29092234048811794)) δℓ: 1.2844843424425136
